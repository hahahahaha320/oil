...
public class EdgeWeightedGraph {
    ...
    public EdgeWeightedGraph(int V,List<Edge>[] adj) {
        this(V);
    ...
    public static void main(String[] args) {
        ...
        adj[0] = Arrays.asList(new Edge(0,1,1),new Edge(0,2,1));
        adj[1] = Arrays.asList(new Edge(1,3,1));
        adj[2] = Arrays.asList(new Edge(2,4,1),new Edge(2,5,1));
        adj[3] = Arrays.asList(new Edge(3,5,1));
        adj[4] = Arrays.asList(new Edge(4,5,1));
        adj[5] = Arrays.asList();
        EdgeWeightedGraph graph = new EdgeWeightedGraph(V,adj);
